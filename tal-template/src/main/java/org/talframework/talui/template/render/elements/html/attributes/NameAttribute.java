...
/**
 * Writes out a name attribute
 * 
 * @author Tom Spencer
 */
public class NameAttribute implements HtmlAttribute {
	private String name = null;
	private String val = null;
	
	public NameAttribute(String name, String val) {
		this.name = name;
		this.val = val;
	}
	...
	public void addAttribute(RenderModel model, GenericElement elem) {
		elem.addNameAttribute(name, val);
	}
}
