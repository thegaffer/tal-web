...
public final class EventConfig {
	...
	public int hashCode() {
		...
		result = prime * result + ((newValueName == null) ? 0 : newValueName.hashCode());
		result = prime * result + ((oldValueName == null) ? 0 : oldValueName.hashCode());
		return result;
	}
	...
	public boolean equals(Object obj) {
	    EventConfig other = BeanComparison.basic(this, obj);
        boolean ret = other != null;
        if( ret && other != this ) {
            ret = BeanComparison.equals(ret, this.attr, other.attr);
            ret = BeanComparison.equals(ret, this.action, other.action);
            ret = BeanComparison.equals(ret, this.newValueName, other.newValueName);
            ret = BeanComparison.equals(ret, this.oldValueName, other.oldValueName);
        }
